  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        else if (res.data.role === "DONOR") window.location.href="/donor";
        else if (res.data.role === "RECIPIENT") window.location.href="/recipient";
        else if (res.data.role === "LOGISTICS") window.location.href="/logistics";
      } else {
